...
class PostProcessorDETR:
    ...
    def __call__(self, lines):
        """
        Args:
            lines: list of dict, each dict contains keys: "pred_relevant_windows"
        Returns:
            processed_lines: list of dict, each dict contains keys: "pred_relevant_windows"
        """
        processed_lines = []
        for line in lines:
    ...
    def clip_min_max_timestamps(self, windows):
        ...
        ensure timestamps for all windows stay within [min_val, max_val]; clip any overflow.
        """
